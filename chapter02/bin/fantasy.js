let thingsToLoad = ["images/fantasy.png", "images/walkcycle.png", "fonts/puzzler.otf", "maps/fantasy.json"];
...
//Game variables
let world, elf, elfTextures, camera, itemsLayer, itemsMapArray, items, message, leftArrow, upArrow, downArrow, rightArrow;
...
function setup() {
  ...
  */
  ...
  of the Tiled map data's width and height. (Note: in this code the 
  fourth argument, the canvas, is added by the Hexi game engine.)
  */
