let thingsToLoad = ["images/timeBombPanic.png", "maps/walkThePath.json"];
...
//Game variables
let alien, wayPoints2DArray, calculateNewPath, destinationX, destinationY;
...
function play() {
  ...
  if (isCenteredOverCell(alien)) {
    ...
    if (calculateNewPath) {
      ...
      let path = shortestPath(getIndex(alien.centerX, alien.centerY, 64, 64, 13), //The start map index
